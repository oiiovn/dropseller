                                ...
                                <table class="table table-nowrap align-middle" id="orderTable">
                                    <thead class="text-muted table-light">
                                        <tr class="text-uppercase">
                                            ...
                                            <th class="sort" data-sort="product_cost">Giá nhập</th>
                                    ...
                                    <tbody class="list form-check-all">
                                        <tr>
                                            ...
                                            <td class="id"><a href="apps-ecommerce-order-details.html" class="fw-medium link-primary">579789654924953800</a>
                                            ...
                                            <td class="shop_name">lovito.vn</td>
