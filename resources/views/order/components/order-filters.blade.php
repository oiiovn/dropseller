...
<div class="filter-section" id="filtersSection">
    <div class="row align-items-end">
        ...
        <div class="col-md-2">
            <select class="form-select" id="paymentFilter" style="color: #666;">
        ...
        <div class="col-md-2">
        <select class="form-select" id="reconciledFilter" style="color: #666;">
...
<script>
  const selectEl = document.getElementById('reconciledFilter');
  const selectEl2 = document.getElementById('paymentFilter');
