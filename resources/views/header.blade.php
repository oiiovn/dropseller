        ...
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <a href="#!" class="stretched-link">
                                                    <h6 class="mt-0 mb-2 lh-base">Shop <b>lovito.vn</b> có đơn hàng mới <span class="text-secondary">579782528716277862</span>!
                                                    </h6>
                                                </a>
                                                <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                    <span><i class="mdi mdi-clock-outline"></i> Vừa xong</span>
                                                </p>
                                            </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user bg-white">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Chào Vũ Bùi!</h6>
                        ...
                        <a class="dropdown-item" href="apps-chat.html"><i class="mdi mdi-message-text-outline text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Shop</span></a>
                        ...
                        <a class="dropdown-item" href="pages-profile.html"><i class="mdi mdi-wallet text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Số dư : <b>856,847 đ</b></span></a>
