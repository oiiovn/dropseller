...
<div class="modal fade" id="negativeBalanceModal" tabindex="-1" aria-labelledby="negativeBalanceLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-danger">
            ...
            <div class="modal-body text-center">
              Bạn vừa được quyết toán đơn tháng vừa rồi<br>Vui lòng kiểm tra lại số dư của bạn.<br> Nạp thêm tiền để được sử dụng các tính năng của hệ thống.
                 <br>
                <span class="text-danger fw-bold">Số dư hiện tại: {{ number_format(Auth::user()->total_amount, 0, ',', '.') }} VNĐ</span>
                
            </div>
            <div class="modal-footer">
               <a class="btn" href="javascript:void(0);" id="openNapTienModal" data-amount="{{ Auth::user()->total_amount }}">Nạp</a>
...
<script>
    $(document).ready(function () {
        // Gán sự kiện click cho nút "Nạp", truyền số tiền từ data-amount
        $(document).on('click', '#openNapTienModal', function () {
            const amount = $(this).data('amount') || 0; // Lấy số tiền từ thuộc tính data-amount
