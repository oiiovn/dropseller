        ...
        <div class="modal-content border-danger">
            ...
            <div class="modal-body text-center">
              Bạn vừa được quyết toán đơn tháng vừa rồi<br>Vui lòng kiểm tra lại số dư của bạn.<br> Nạp thêm tiền để được sử dụng các tính năng của hệ thống.
                 <br>
                <span class="text-danger fw-bold">Số dư hiện tại: {{ number_format($negativeBalance, 0, ',', '.') }} VNĐ</
                
            </div>
            <div class="modal-footer">
                             < class="text-danger fw-bold">Số dư hiện tại: {{ number_format($negativeBalance, 0, ',', '.') }} VNĐ</
