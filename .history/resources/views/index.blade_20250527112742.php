    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-danger">
            ...
            <div class="modal-body text-center">
                Một hoặc nhiều ví của bạn đang có số dư âm.<br>Vui lòng kiểm tra và xử lý sớm!
            </div>
            <div class="modal-footer">
                <a href="{{ route('wallets.index') }}" class="btn btn-danger">Xem ví</a>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        var showWelcomeModal = {!! json_encode($showWelcomeModal) !!};
        var hasNegativeBalance = @json($hasNegativeBalance);
